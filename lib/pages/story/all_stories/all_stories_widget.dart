...
import 'all_stories_model.dart';
export 'all_stories_model.dart';

class AllStoriesWidget extends StatefulWidget {
  const AllStoriesWidget({super.key});
...
class _AllStoriesWidgetState extends State<AllStoriesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllStoriesModel());
