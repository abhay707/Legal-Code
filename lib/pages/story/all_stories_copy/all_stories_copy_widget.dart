...
import 'all_stories_copy_model.dart';
export 'all_stories_copy_model.dart';

class AllStoriesCopyWidget extends StatefulWidget {
  const AllStoriesCopyWidget({super.key});

  @override
  State<AllStoriesCopyWidget> createState() => _AllStoriesCopyWidgetState();
}

class _AllStoriesCopyWidgetState extends State<AllStoriesCopyWidget> {
  late AllStoriesCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllStoriesCopyModel());
                              ...
                              child: Column(
                                ...
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(12.0),
                                    child: Image.asset(
                                      'assets/images/shadow_of_childhood.png',
                                      width: double.infinity,
                                      height: 365.0,
                                      fit: BoxFit.cover,
                                    ),
                        ...
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: InkWell(
                              ...
                              highlightColor: Colors.transparent,
                              onTap: () async {
                                context.pushNamed('Strory3part1');
                              },
                              child: Column(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  ClipRRect(
                                    borderRadius: BorderRadius.circular(12.0),
                                    child: Image.asset(
                                      'assets/images/silentstruggle.png',
                                      width: double.infinity,
                                      height: 365.0,
                                      fit: BoxFit.cover,
                                    ),
