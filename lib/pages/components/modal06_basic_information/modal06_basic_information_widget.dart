...
class Modal06BasicInformationWidget extends StatefulWidget {
  const Modal06BasicInformationWidget({super.key});
...
class _Modal06BasicInformationWidgetState
    extends State<Modal06BasicInformationWidget> {
  late Modal06BasicInformationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Modal06BasicInformationModel());
