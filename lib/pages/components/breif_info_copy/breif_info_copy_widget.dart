...
import 'breif_info_copy_model.dart';
export 'breif_info_copy_model.dart';

class BreifInfoCopyWidget extends StatefulWidget {
  const BreifInfoCopyWidget({super.key});

  @override
  State<BreifInfoCopyWidget> createState() => _BreifInfoCopyWidgetState();
}

class _BreifInfoCopyWidgetState extends State<BreifInfoCopyWidget> {
  late BreifInfoCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BreifInfoCopyModel());
